...
/*   Updated: 2023/05/19 11:58:11 by rerayyad         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_canvas_launcher(t_canvas *mlx)
{
	...
	mlx->offset_x = 500;
	mlx->offset_y = 250;
	mlx->offset_x_iso = 650;
	mlx->offset_y_iso = 150;
	mlx->img.alpha = 0;
	mlx->img.beta = 0;
	mlx->img.gamma = 0;
	mlx->rot = 0;
...
int	main(int ac, char *av[])
{
	...
	ft_drawzilla(mlx.fdf, &mlx, ft_height(av[1]));
	ft_keylogger(&mlx, ft_height(av[1]), 1);
	return (0);
}
